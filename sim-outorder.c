...
static int neural_nelt = 4;
static int neural_config[4] = 
  {/* n of perceptrons */1024, /* m of perceptrons */1024 , /* history length */16 , /* nr of weight bits */6  };
...
"  Predictor `comb' combines a bimodal and a 2-level predictor.\n"
  ...
  opt_reg_int_list(odb, "-bpred:neural",
		   "neural predictor config " 
	           "(<nr_of_perceptrons> <nr_of_weight_bits> <history_length> <weight_size>)",
  ...
  if (!mystricmp(pred_type, "perfect"))
	...
	fatal("bad btb config (<num_sets> <associativity>)");
	  pred = bpred_create(BPredPerceptron,
			  ...
			  /* history length */    neural_config[2],
			/* weight size */ 	neural_config[3], 0,
			  /* btb sets */btb_config[0],
			  /* btb assoc */btb_config[1],
			  /* ret-addr stack size */ras_size);
    }
	...
	fatal("bad btb config (<num_sets> <associativity>)");
      ...
      pred = bpred_create(BPred2Level,
			  ...
			  /* meta table size */0,
			  /* history reg size */twolev_config[2],0,
